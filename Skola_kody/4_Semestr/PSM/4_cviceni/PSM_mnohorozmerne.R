...
#Faktory jsou důležité, když jsouvětší hodnoty než 0.5 u loadings
...
#Vyšlo, že tyhle informace se liší na základé počtu válců, tak manuál/automatika
#ale žádná interakce tam není
summary.aov(fit)
summary(fit, test="Hotelling-Lawley")
...
# No clue, co mi tohle dává za informace, upřímně jsem úplně lost
################################
