...
public Automobil (string name, int pocet_kol, double GPSpozice_x = 0, double GPSpozice_y = 0){
    this.Name = name;
    this.Pocet_kol = pocet_kol;
